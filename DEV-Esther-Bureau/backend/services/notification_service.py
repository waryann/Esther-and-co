...
def get_twilio_client():
    ...
    # Un vrai Account SID Twilio commence toujours par "AC" : ça filtre
    # les valeurs placeholder (ex: "simulate_account_sid") sans appel réseau.
    if not account_sid or not auth_token or not account_sid.startswith("AC"):
