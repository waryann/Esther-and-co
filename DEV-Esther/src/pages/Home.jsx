...
import gifVideo from '../assets/images/Gif.gif'
  ...
  return (
    <main className="home">
      ...
      <section className="editorial">
        ...
        >
          <img src={gifVideo} alt="EST'HAIR & CO." className="editorial__fullscreen-img" />
        ...
        <div className="editorial__banner">
          ...
          >
            <img src={gifVideo} alt="EST'HAIR & CO." className="editorial__banner-img" />
