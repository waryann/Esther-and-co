...
with app.app_context():
    ...
    order1 = Order(
        user_id=2,  # Marie Dupont
    if User.query.first() or Product.query.first() or Service.query.first():
        print("Les données existent déjà. Le script ne va pas les écraser.")
        print("Si vous voulez réinitialiser, supprimez les données manuellement.")
    else:
        print("Création des utilisateurs...")
        # Admin
        admin = User(
